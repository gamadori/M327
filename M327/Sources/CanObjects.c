...
/*
 * index 1018: indentify object 
 */
 
 td_identity theIdentity = 
 {
 	4,		// numero di entries
...
const td_subIndex Index1018[] = 
{
	{dicRO, tUNSIGNED8, 	SIZEOFW_BYTE,	(void *)&theIdentity.count},
	{dicRO, tUNSIGNED32,	SIZEOFW_DWORD, 	(void *)&theIdentity.vendor_id},
	{dicRO, tUNSIGNED32,	SIZEOFW_DWORD,	(void *)&theIdentity.product_code},
	{dicRO, tUNSIGNED32,	SIZEOFW_DWORD,	(void *)&theIdentity.revision_number},
	{dicRO, tUNSIGNED32,	SIZEOFW_DWORD,	(void *)&theIdentity.serial_number}
};
 ...
 const td_indexTable CommunicationProfileArea[] =
{
	...
	{NULL, 0},		// 1016
	{NULL, 0},		// 1017
	DeclareIndexTableEntry(Index1018, VAR)
};
...
td_pdo_communication_parameter RxPDO1 = { 3,  0x180, 255, 2000 };
...
td_pdo_communication_parameter RxPDO2 = { 3, 0x280, 255, 2000 };
...
td_pdo_communication_parameter RxPDO3 = { 3, 0x380, 255, 2000 };
...
td_pdo_communication_parameter RxPDO4 = { 3, 0x480, 255, 2000 };
...
td_pdo_communication_parameter TxPDO1 = { 3, 0x200, 255, 1 };
...
td_pdo_communication_parameter TxPDO2 = { 3, 0x300, 255, 1};
...
td_pdo_communication_parameter TxPDO3 = { 3, 0x400, 255, 1};
...
td_pdo_communication_parameter TxPDO4 = { 3, 0x500, 255, 1 };
